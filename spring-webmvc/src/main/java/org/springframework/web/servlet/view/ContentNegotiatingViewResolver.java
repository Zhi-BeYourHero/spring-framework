...
public class ContentNegotiatingViewResolver extends WebApplicationObjectSupport
	...
	/**
	 * ContentNegotiationManager的工厂， 用于创建{@link #contentNegotiationManager} 对象
	 */
	...
	/**
	 * ViewResolver 数组，ContentNegotiatingViewResolver 会使用这些 viewResolvers 们，
	 * 解析出所有的 View 们，然后基于内容类型来获取对应的 View 们。
	 * 此时的 View 结果，可能是一个，可能是多个，所以需要比较获取到最优的 View 对象。
	 */
	@Nullable
	...
	protected void initServletContext(ServletContext servletContext) {
		...
		// 默认情况下，走的是这段逻辑。所以此时 viewResolvers 会有 BeanNameViewResolver、ThymeleafViewResolver、
		// ViewResolverComposite、InternalResourceViewResolver 四个对象。
